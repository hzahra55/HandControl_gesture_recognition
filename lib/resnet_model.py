...
#         )(conv_1_1)
#         residual = _bn_relu_conv3d(
#             filters=filters * 4, kernel_size=(1, 1, 1), kernel_regularizer=kernel_regularizer
#         )(conv_3_3)
...
#         if len(input_shape) != 4:
#             raise ValueError(
#                 "Input shape should be a tuple (conv_dim1, conv_dim2, conv_dim3, channels)"
#             )
...
#                 block_fn, filters=filters, kernel_regularizer=l2(reg_factor), repetitions=r, is_first_layer=(i == 0)
#             )(block)
#             filters *= 2
#             block = Dropout(drop_rate)(block)
...
#             pool_size=(block.shape[DIM1_AXIS], block.shape[DIM2_AXIS], block.shape[DIM3_AXIS]), strides=(1, 1, 1)
#         )(block_output)
#         flatten1 = Flatten()(pool2)
#         if num_outputs > 1:
#             dense = Dense(
